...
public class DreamBiomes {
    ...
    public static final ResourceKey<Biome> EVERGREEN_FOREST = Dreamlands.createKey(Registries.BIOME, "evergreen_forest");
    public static final ResourceKey<Biome> ETHEREAL_FOREST = Dreamlands.createKey(Registries.BIOME, "ethereal_forest");
    public static final ResourceKey<Biome> COTTON_CANDY_FOREST = Dreamlands.createKey(Registries.BIOME, "cotton_candy_forest");
