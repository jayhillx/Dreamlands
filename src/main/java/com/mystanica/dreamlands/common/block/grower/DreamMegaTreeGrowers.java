...
public class DreamMegaTreeGrowers extends AbstractMegaTreeGrower {
    private final ResourceKey<ConfiguredFeature<?, ?>> feature;
    private final ResourceKey<ConfiguredFeature<?, ?>> megaFeature;

    public DreamMegaTreeGrowers(ResourceKey<ConfiguredFeature<?, ?>> feature, ResourceKey<ConfiguredFeature<?, ?>> megaFeature) {
