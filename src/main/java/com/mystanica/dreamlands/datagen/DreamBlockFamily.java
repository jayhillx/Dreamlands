...
public class DreamBlockFamily {
    ...
    public DreamBlockFamily(Block block) {
    ...
    public static class Builder {
        private final DreamBlockFamily family;

        public Builder(Block block) {
            this.family = new DreamBlockFamily(block);
        }

        public DreamBlockFamily getFamily() {
            return this.family;
        }
        ...
        public Builder stone(Block block) {
            this.family.variants.put(Variant.STONE, block);
            return this;
        }
